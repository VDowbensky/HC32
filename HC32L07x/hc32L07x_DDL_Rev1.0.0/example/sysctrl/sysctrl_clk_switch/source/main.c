...
void App_Rch24MHzToXth8MHz (void);
void App_Xth8MHzToPll48MHz (void);
/**
 ******************************************************************************
...
{   
    ...
    //将时钟从RCH24MHz切换至XTH8MHz, PA01观察时钟波形，(3s后)按下按键继续运行
    App_Rch24MHzToXth8MHz();
    
    //将时钟从XTH8MHz切换至PLL48MHz, PA01观察时钟波形，(3s后)按下按键继续运行
    App_Xth8MHzToPll48MHz();
