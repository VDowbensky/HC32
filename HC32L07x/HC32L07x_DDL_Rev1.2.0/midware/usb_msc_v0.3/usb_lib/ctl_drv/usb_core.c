...
//    USB_OTG_GRSTCTL_TypeDef greset = {.d32 = 0 };
    ...
    if(pdev->cfg.coreID == USB_OTG_FS_CORE_ID  )
    {
        ...
        USB_OTG_WRITE_REG32( &pdev->regs.GREGS->DPTXFSIZ[2], nptxfifosize.d32 );
				...
				nptxfifosize.b.startaddr = nptxfifosize.b.startaddr + nptxfifosize.b.depth;
        nptxfifosize.b.depth = TX3_FIFO_FS_SIZE;
        USB_OTG_WRITE_REG32( &pdev->regs.GREGS->DPTXFSIZ[3], nptxfifosize.d32 );
				
				nptxfifosize.b.startaddr = nptxfifosize.b.startaddr + nptxfifosize.b.depth;
        nptxfifosize.b.depth = TX3_FIFO_FS_SIZE;
        USB_OTG_WRITE_REG32( &pdev->regs.GREGS->DPTXFSIZ[4], nptxfifosize.d32 );
				
				nptxfifosize.b.startaddr = nptxfifosize.b.startaddr + nptxfifosize.b.depth;
        nptxfifosize.b.depth = TX3_FIFO_FS_SIZE;
        USB_OTG_WRITE_REG32( &pdev->regs.GREGS->DPTXFSIZ[5], nptxfifosize.d32 );
				
				nptxfifosize.b.startaddr = nptxfifosize.b.startaddr + nptxfifosize.b.depth;
        nptxfifosize.b.depth = TX3_FIFO_FS_SIZE;
        USB_OTG_WRITE_REG32( &pdev->regs.GREGS->DPTXFSIZ[6], nptxfifosize.d32 );
        #if 0
