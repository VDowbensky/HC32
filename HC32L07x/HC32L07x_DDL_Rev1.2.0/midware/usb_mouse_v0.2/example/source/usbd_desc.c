...
#define USBD_CONFIGURATION_HS_STRING    "MOUSE Config"
#define USBD_INTERFACE_HS_STRING        "MOUSE Interface"
#define USBD_CONFIGURATION_FS_STRING    "MOUSE Config"
#define USBD_INTERFACE_FS_STRING        "MOUSE Interface"
/**
  * @}
  */ 
