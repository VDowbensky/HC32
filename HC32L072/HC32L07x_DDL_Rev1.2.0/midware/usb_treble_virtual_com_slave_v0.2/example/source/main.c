...
char buf3[]="This is a sample about usb cdc_5ep\n";
int32_t main(void)
{
    ...
    while(1)
    {
        ...
        if(USB_USART_RX_STA[2] & 0x4000)
        {
            usbdevice2pc(&USB_OTG_dev, buf3, strlen(buf3), CDC_IN_EP2);
            USB_USART_RX_STA[2] = 0;            
        }
	}
}
