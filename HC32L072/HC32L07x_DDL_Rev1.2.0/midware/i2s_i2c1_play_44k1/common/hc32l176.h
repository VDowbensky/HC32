...
** History:
**
**   - 2019-03-01  0.1   Lux First version.
**
******************************************************************************/
...
typedef struct
{
    ...
    union
    {
        __IO uint32_t PREI_RESET0;
        stc_reset_prei_reset0_field_t PREI_RESET0_f;
    };
    union
    {
        __IO uint32_t PREI_RESET1;
        stc_reset_prei_reset1_field_t PREI_RESET1_f;
    };
}M0P_RESET_TypeDef;
